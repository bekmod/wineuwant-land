...
<div
  class="container relative z-50 flex justify-between items-center mx-auto py-4 px-8"
>
  <div class="flex-1 flex my-auto justify-start">
    <Reveal y={-20} delay={0}>
      <button
        class="flex items-center justify-start gap-2 cursor-pointer hover:opacity-70 transition-opacity"
        onclick={toggleMenu}
      ...
      >
        ...
        {:else}
          <svg
            class="w-6 h-6 text-menu-grey-400"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
        ...
        {/if}
        <p class="h-full text-base font-medium text-menu-grey-400">
  ...
  <Reveal y={-20} delay={100} class="flex items-center justify-center">
    <Logo />
  </Reveal>

  <div class="flex-1 flex items-center justify-end my-auto">
